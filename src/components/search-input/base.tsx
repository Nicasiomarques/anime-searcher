...
export const InputField: React.FC<InputFieldProps> = ({ label,...rest }) =>
  <div className="flex flex-col gap-2">
    ...
    <input type="text" className="bg-white rounded px-4 py-3 w-full shadow-sm shadow-slate-300 focus:shadow-md focus:-translate-y-1 outline-none transition-all duration-200" {...rest} />
  </div>
